...
<html>
  ...
  $('#container').highcharts({
      ...
      title: {
          text: 'Indice de acertividad en el examen ServTec.'
      },
      subtitle: {
          text: 'Detalles'
      },
      ...
      series: [{
          ...
          data: [
              ...
              $sql = $mysqli->query("select totalRespuestas*100/1000 as aciertos, (1000-totalRespuestas)*(100)/1000 as errores from resultado where idAspirante=$var;");
  ...
  <body>
    ...
    if(isset($_SESSION['nombre']) && $_SESSION['status'] == 1 && $r == 1) {
      ...
      institucion.direccion as direccion, institucion.CCT as cct, institucion.telefono as telefono, aspirante.folio as ncontrol from resultado join aspirante using(idAspirante) join institucion using(idInstitucion) where idAspirante = $var;";
    ...
    <div class="row-fluid">
      ...
      <div class="col-md-6">
        <div class="row-fluid">
          <div class="panel panel-primary">
            <div class="panel-heading text-center">Datos del Alumno</div>
            <div class="panel-body">
              <table class="table table-hover ">
              <tbody>
              <tr>
              <td width="550px" class="text-right"><strong>Folio: </strong></td>
              <td width="550px"><?php printf($obj->folio);?></td>
              </tr>
              <tr>
              <td class="text-right"><strong>Nombre: </strong></td>
              <td><?php printf($obj->alumno);?></td>
              </tr>
			  <tr>
              <td class="text-right"><strong>Número de Control: </strong></td>
              <td><?php printf($obj->ncontrol);?></td>
              </tr>
              <tr>
              <td class="text-right"><strong>Fecha de Aplicación: </strong></td>
              <td><?php printf($obj->faplicacion);?></td>
              </tr>    
			  <tr>
              <td class="text-right"><strong>Institución: </strong></td>
              <td><?php printf($obj->escuela);?></td>
              </tr>
			  <tr>
              <td class="text-right"><strong>Dirección: </strong></td>
              <td><?php printf($obj->direccion);?></td>
              </tr>
			  <tr>
              <td class="text-right"><strong>CCT: </strong></td>
              <td><?php printf($obj->cct);?></td>
              </tr>
			  <tr>
        ...
        <div class="row-fluid">
          <div class="panel panel-primary">
            <div class="panel-heading text-center">Dictamen general en el examen</div>
    ...
    <div class="row-fluid">
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading text-center">Criterios para el otorgamiento del testimonio de desempeño en el examen</div>
          <div class="panel-body">
            <table class="table table-hover ">
              <tbody>
                <tr>
    ...
    <div class="row-fluid">
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading text-center">Desempeño en cada área del examen</div>
          <div class="panel-body">
