<?php
namespace Model\Dao\Aspirante;

use Model\Beans\Aspirante as AspiranteBean;
use Model\Dao\Aspirante\AspiranteSQL as AspiranteSQL;
...
class AspiranteDao {
    ...
    function  registrarAspiranteDao($aspirante){        
        ...
        $st=  procesaParametros::PrepareStatement(AspiranteSQL::registrarAspirante(),$datosArray);
    ...
    function actualizarAspiranteDao($aspirante){
        ...
        $st=  procesaParametros::PrepareStatement(AspiranteSQL::actualizarAspirante(),$datosArray);
    ...
    function eliminarAspiranteDao($aspirante){
        ...
        $st1 = procesaParametros::PrepareStatement(AspiranteSQL::eliminarAspirante(), $datosArray1);
    ...
    function traeDatosAspiranteDao($datos){
      ...
      $Pp = procesaParametros::PrepareStatement(AspiranteSQL::traerDatosIdSql(), $datosArray);
      $query= $this->con->query($Pp);                  
      $query->data_seek(0);
      $row=$query->fetch_array();
      $lista= new AspiranteBean();
